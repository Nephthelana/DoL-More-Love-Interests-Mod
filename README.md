...
- 关于模组版本与游戏版本的说明：
  - v0.5.10.x版本的游戏请使用v0.1.7.0版本的模组，
  - v0.5.7.x版本的游戏请使用v0.1.6.0版本的模组，
  - v0.5.6.x版本的游戏请使用v0.1.5.0版本的模组，
  - v0.5.5.x版本的游戏请使用v0.1.4.0版本的模组，
...
## 使用说明
本模组对于原版设定恋人的机制改动如下：
- 删除主要恋人/次要恋人选项。恋人数量不受意识等级影响，上限为11；
- 目前只能设定原版10位li，以及雷米恋爱模组新增的雷米li，共11个NPC为恋人；
- “恋人”栏中的对象均会受到`终生伴侣`特质加成，且未开启相关设置时，更换恋人不会导致该特质的负面影响。
## 注意事项
- 模组最新版本（v0.1.7.0）适配游戏本体v0.5.10.x及以上的版本。其他游戏版本请参考[下载方式](#下载方式)中的说明；
- 卸载本模组前，请先手动将“恋人”栏内设定的恋人数量调整为3及以下，因为模组并没有提供“卸载模组后删去额外设定的恋人”的功能，卸载模组后将无法操作位次靠后的恋人设定；
- 写着玩的，不要二传。
## 友情链接
